local strings = {
    ...
    ["SI_AUTORESEARCH_SHORT_PREFIX_TOOLTIP"]   = "Wenn aktiviert, wird bei alle Chat-Nachrichten AR anstelle von AutoResearch vorangestellt.",
    ["SI_AUTORESEARCH_COLORED_PREFIX"]         = "Verwenden die AutoResearch 1 Präfix Farbe",
    ["SI_AUTORESEARCH_COLORED_PREFIX_TOOLTIP"] = "Bewirkt, dass das Präfix für Chat-Nachrichten die blauen Farben von AutoResearch 1 (d. H. |c99CCEFAutoResearch|r oder |c99CCEFAR|r) anstelle der Einstellung für die Chat-Nachrichten Farbe verwendet.",
